...
def assembly(mesh, P: int, repeats: int, jit_options: dict | None = None):
    ...
    A = dolfinx.cpp.la.petsc.create_matrix(mesh.comm, A_sp._cpp_object, None)
    Ax = dolfinx.cpp.la.petsc.create_matrix(mesh.comm, A_sp._cpp_object, None)
    D = dolfinx.cpp.la.petsc.create_matrix(mesh.comm, A_sp._cpp_object, None)
    D.assemble()
